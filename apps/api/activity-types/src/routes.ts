...
import { patchActiveStatus } from "./v1/activity-types/id/patch/patch-activity.route";
import { V1_PATCH_ACTIVITY_KEY } from "./v1/activity-types/id/patch/patch-activity.type";
...
export const ROUTE_HANDLING_MAP = {
  ...
  [ROUTE_KEYS.V1_PATCH_ACTIVITY_KEY]: patchActiveStatus,
};
